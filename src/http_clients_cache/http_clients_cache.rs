...
#[derive(Default)]
pub struct FlUrlHttpClientsCacheInner {
...
pub struct FlUrlHttpClientsCache {
    pub inner: RwLock<FlUrlHttpClientsCacheInner>,
}

impl FlUrlHttpClientsCache {
    pub fn new() -> Self {
        Self {
            inner: RwLock::new(FlUrlHttpClientsCacheInner::default()),
        }
    }
}
